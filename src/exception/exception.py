...
class customException(Exception):  # inheriting predefined Exception class
    ...
    def __init__(self, error_message, error_details:sys): 
        ...
        _,_,execution_traceback = error_details.exc_info() # exc_info() returns a tuple of 3 elements (type of exception, exception object, traceback object)
    ...
    def __str__(self):
        return "\n\nERROR OCCURED IN PYTHON SCRIPT NAME : [{0}] \n\nIN LINE NUMBER : [{1}]\n\nERROR MESSAGE :[{2}]\n\n".format(self.file_name, self.line_number, str(self.error_message))
